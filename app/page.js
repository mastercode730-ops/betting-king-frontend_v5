    ...
    <div id="wrapper">
      ...
      {royalLead && (
        <div className="lrs">
          ...
          <span className="lrs-num">
            {!royalLead.today_number ||
            royalLead.today_number === "XX" ||
            royalLead.today_number === "--"
              ? "??"
              : royalLead.today_number}
          </span>
          <a
            ...
            className="btn-wa-festive"
            style={{ padding: "2px 10px", fontSize: "11px", marginLeft: 8 }}
          >
            💬 WhatsApp
          </a>
        </div>
      ...
      <div className="wrap">
        ...
        <div className="wa-royal-banner">
          <div>
            <div className="wa-royal-title">
              👑 सीधा खाईवाल दरबार &bull; 100% ईमानदार गेम बुकिंग
            </div>
            <div className="wa-royal-sub">
        ...
        {royalLead && (
          <div className="arch">
            ...
            <p className="prevline">
              समय: <b>{royalLead.draw_time}</b> &nbsp;|&nbsp; कल का शुभ अंक:{" "}
              <b>{royalLead.yesterday_number || "—"}</b>
            </p>
        ...
        <footer className="royal-footer">
          <p style={{ color: "var(--gold-2)", marginBottom: 12 }}>
            SATTA KING MAX ROYAL EDITION &bull; 2026
          </p>
